<?php
	...
	$result = pg_query("SELECT identyfikator, dane_tekstowe, dane_numeryczne, ST_AsGeoJSON(dane_geograficzne,5)  as geometria FROM public.tabela_przykladowa ORDER BY identyfikator ASC");
